...
local isdir = function(path) return love.filesystem.getInfo(path).type == "directory" end
local time = love.timer.getTime or os.time
local lastmodified = function(path) return love.filesystem.getInfo(path).modtime end
