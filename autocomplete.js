...
let prop_z = {
  prop: "z",
  info: "lower numbers are drawn behind higher numbers",
};
let prop_xy = [{ prop: "x" }, { prop: "y" }];
let prop_xyz = [...prop_xy, prop_z];
let prop_pixi_point = name => ({
  prop: name || "point",
  info: "{ x, y, set(x, y=x) }",
});
let prop_gameobject = [
...
module.exports.hints = {
  global: [
    ...
    {
      fn: "switch",
      vars: { v: "", choices_t: "{ choice1 = function() end, ... }" },
    },
    { fn: "copy", vars: { t: "" }, info: "returns deepcopy of table" },
    { fn: "is_object", vars: { v: "" }, info: "is v an instance of a class" },
    {
      fn: "encrypt",
      vars: { str: "", code: "hashing key", seed: "opt number" },
    },
    {
      fn: "decrypt",
      vars: {
        hashed_str: "",
        code: "hashing key used to encrypt",
        seed: "opt number used to encrypt",
      },
    },
  ],
  "blanke-table": [
    ...
    {
      fn: "slice",
      vars: { t: "", start: "opt 1", end: "opt #t" },
      info: "returns segment of table",
    },
    ...
    { fn: "append", vars: { t: "", new_t: "" } },
    {
      ...
      vars: {
        t: "",
        fn: "(item, index) => true to keep value, false to remove",
      },
    },
    { fn: "random", vars: { t: "" } },
  ...
  "blanke-math": [
    ...
    { fn: "sinusoidal", vars: { min: "", max: "", speed: "", offset: "opt" } },
    {
      fn: "angle",
      vars: { x1: "", y1: "", x2: "", y2: "" },
      args: "returns angle between two points abs(atan2)",
    },
  ...
  "blanke-fs": [
    ...
    { fn: "dirname", vars: { path: "" } },
    {
      fn: "extname",
      vars: { path: "" },
      info: "returns extension with period",
    },
  ...
  "blanke-image": [
    ...
    {
      fn: "animation",
      vars: { file: "", animations: "{name,}", global_options: "" },
    },
  ],
  "blanke-input": [
  ...
  "blanke-map-instance": [
    ...
    {
      fn: "spawnEntity",
      vars: { object_name: "", x: "", y: "", layer: "opt" },
    },
  ],
  "blanke-physics": [
  ...
  "blanke-hitbox": [
    ...
    {
      fn: "adjust",
      vars: { obj: "", left: "", top: "", width: "", height: "" },
      info: "resize a hitbox",
    },
    { fn: "remove", vars: { obj: "" } },
  ],
  "blanke-net": [],
  "blanke-timer": [
    {
      fn: "after",
      vars: { t: "seconds", fn: "return true to restart the timer" },
    },
    {
      fn: "every",
      vars: { t: "seconds", fn: "return true to destroy the timer" },
    },
  ],
};
